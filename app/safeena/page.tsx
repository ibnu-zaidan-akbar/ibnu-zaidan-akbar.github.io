...
export default function Safeena() {
    ...
    const foto = [
        { id: 1, src: "/assets/s1.png"},
        { id: 2, src: "/assets/s2.png"},
        { id: 3, src: "/assets/s3.png"},
        { id: 4, src: "/assets/s4.png"},
        { id: 5, src: "/assets/s5.png"},
        { id: 6, src: "/assets/s6.png"}
    ];
            ...
            <main className="bg-dark">
                <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,var(--light)_0%,transparent_30%),radial-gradient(circle_at_bottom_left,var(--light)_0%,var(--dark)_30%)]">
                    <div className="flex flex-col md:grid md:grid-cols-[20%_80%] justify-center items-center py-4 lg:py-8 md:px-12 lg:px-12 xl:px-20">
                        <div className="p-4 md:p-6 lg:p-8 xl:p-10 bg-[#E0E4E7]/70 rounded-full justify-center items-center">
                            <Image
                                src="/assets/ls.svg" alt="logo safeena"
                                width={360} height={310}
                                className="w-[150px] h-[150px] md:w-[550px] md:h-[90px] lg:w-[500px] lg:h-[120px] xl:w-[450px] xl:h-[170px]"
                            />
                        </div>
                        <div className="flex flex-col gap-4 md:gap-2 p-8 justify-center">
                            <span className="text-[20px] md:text-[28px] lg:text-[32px] xl:text-[42px] text-center md:text-start font-bold leading-none">Website Company Profile for Safeena Academy</span>
                    ...
                    <div className="max-w h-fit flex p-8 justify-center align-center">
                        <a className="text-[16px] md:text-[20px] xl:text-[24px]" href="#" target="_blank">View Project 👁</a>
                    </div>
                </div>
            </main>
        )
